...
Binghao Deng cited papers, added information to multiple sections(introduction, results, and discussionn), and also contributed to data collection (timing 100s for each temperature reading)
